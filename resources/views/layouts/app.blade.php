            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <a href="{{ route('/') }}" class="nav-link text-white bg-dark rounded btn-sm">Home</a>
                    </ul>
        ...
        <main class="container py-4">
            <div class="row">
                <div class="col-md-4">
                    ...
                    @auth
                        <a href="{{ route('discussions.create') }}" style="width: 100%" class="btn btn-dark my-2 ">Create Discussions</a>
                    @endauth
                    ...
                    <div class="card">
                        ...
                        <div class="card-body bg-dark">
                            <ul class="list-group">
                                <li class="list-group-item"><a href="{{ route('discussions.index') }}">All Channels</a></li>
